...
Gem::Specification.new do |s|
  ...
  s.extra_rdoc_files = ["lib/connection_ninja.rb", "README.markdown"]
  s.files = ["config/connection_ninja.yml", "lib/connection_ninja.rb", "Manifest", "Rakefile", "README.markdown", "spec/connection_ninja_spec.rb", "spec/fixtures/models.rb", "spec/fixtures/structure.sql", "spec/spec_helper.rb", "spec/test_helper.rb", "connection_ninja.gemspec"]
